...
from CowMusic.utils import (Cowbin, get_channeplayCB,
                              seconds_to_min)
from CowMusic.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from CowMusic.utils.decorators.language import language, languageCB
from CowMusic.utils.inline import queue_back_markup, queue_markup
