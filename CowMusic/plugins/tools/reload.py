...
from CowMusic.utils.database import get_authuser_names, get_cmode
from CowMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from CowMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Cow.stop_stream(message.chat.id)
    except:
        pass
