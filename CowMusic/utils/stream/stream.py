...
import config
from CowMusic import Carbon, YouTube, app
from CowMusic.core.call import Cow
from CowMusic.misc import db
from CowMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from CowMusic.utils.exceptions import AssistantErr
from CowMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from CowMusic.utils.inline.playlist import close_markup
from CowMusic.utils.pastebin import Cowbin
from CowMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Cow.force_stop_stream(chat_id)
