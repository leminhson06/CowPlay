# Cow Music Bot Configs

Config vars are basically the variables which configure or modify bot to function, which are the basic necessities of plugins or code to work. You have to set the proper mandatory vars to make it functional and to start the basic feature of bot.

### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://notreallyshikhar.gitbook.io/Cowmusicbot/config-vars/available-vars)

## Mandatory Vars

- These are the minimum required vars need to setup to make Cow Music Bot functional.

1. `API_ID` : Get it from my.telegram.org 
2. `API_HASH`  : Get it from my.telegram.org 
3. `BOT_TOKEN` : Get it from [@Botfather](http://t.me/BotFather) in Telegram
4. `MONGO_DB_URI` : Get mongo db [from here.](https://notreallyshikhar.gitbook.io/Cowmusicbot/deployment/mongodb)
5. `LOG_GROUP_ID` : You'll need a Private Group ID for this. Supergroup Needed with id starting from -100 
6. `MUSIC_BOT_NAME` : A name for your Music bot.
7. `OWNER_ID` : Your Owner ID for managing your bot.
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@CowStringBot](http://t.me/CowStringBot) in Telegram.
...
- You can play tracks or playlists from spotify from Cow Music bot
- You'll need these two vars to make spotify play working. This is not essential , you can leave them blank if you want.

### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/Cowmusicbot/deployment/spotify)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/Cowmusicbot/config-vars/heroku-vars)
...
- If you plan to use Cow Music Bot with your own customized or modified code.
...
- You can change images which are used in Cow Music Bot.
- You can generate telegaph links from [@CowTelegraphBot](http://t.me/CowTelegraphBot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@CowStringBot](http://t.me/CowStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@CowStringBot](http://t.me/CowStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@CowStringBot](http://t.me/CowStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@CowStringBot](http://t.me/CowStringBot) in Telegram.
