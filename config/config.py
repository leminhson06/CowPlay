...
)  # Example:- https://t.me/TheCow
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/CowSupport
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @CowStringBot
